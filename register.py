...
"color:rgb(6, 160, 170);")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("C:/pyqt5/MATELRIAL/IMG/icons8-home-1000.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"color: rgb(6, 160, 170);")
        ...
        self.register_account_label.setPixmap(QtGui.QPixmap("C:/pyqt5/MATELRIAL/IMG/account.jpg"))
        ...
        self.register_b3b3Logo_label.setPixmap(QtGui.QPixmap("C:/pyqt5/MATELRIAL/IMG/Logo.jpg"))
